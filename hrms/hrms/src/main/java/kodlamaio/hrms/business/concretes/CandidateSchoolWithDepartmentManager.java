...
public class CandidateSchoolWithDepartmentManager implements CandidateSchoolWithDepartmentService{
	...
	public DataResult<List<CandidateSchoolWithDepartment>> getAllByCandidateIdOrderByEndingDateDesc(int candidateId) {
		return new SuccessDataResult<List<CandidateSchoolWithDepartment>>(this.candidateSchoolWithDepartmentDao.getAllByCandidateIdOrderByEndingDateDesc(candidateId));
	}

	@Override
	public DataResult<List<CandidateSchoolWithDepartment>> getAllByOrderByEndingDateDesc() {
		return new SuccessDataResult<List<CandidateSchoolWithDepartment>>(this.candidateSchoolWithDepartmentDao.getAllByOrderByEndingDateDesc());
	}
